...
TEST(QueenMoves, test_general_moves_pos35) {
  ...
  game_state.board.fields[field_before] = Piece::white_queen;
  game_state.board.fields[51] = Piece::black_rook;
  game_state.board.fields[42] = Piece::white_knight;
  game_state.board.fields[62] = Piece::black_bishop;
  game_state.board.fields[21] = Piece::white_pawn;
