...
TEST(BishopMoves, test_general_moves_pos35) {
  ...
  game_state.board[field_before] = Piece::white_bishop;
...
TEST(BishopMoves, test_no_move_possible) {
  ...
  game_state.board[field_before] = Piece::white_bishop;
  game_state.board[25] = Piece::white_king;
  game_state.board[27] = Piece::white_pawn;
  game_state.board[9] = Piece::white_queen;
  game_state.board[11] = Piece::white_rook;
...
TEST(BishopMoves, test_general_moves_pos56) {
  ...
  game_state.board[field_before] = Piece::black_bishop;
  game_state.board[42] = Piece::white_pawn;
  game_state.board[21] = Piece::black_knight;
...
TEST(BishopMoves, test_general_moves_pos37) {
  ...
  game_state.board[field_before] = Piece::black_bishop;
  game_state.board[19] = Piece::white_pawn;
  game_state.board[46] = Piece::black_knight;
...
TEST(BishopMoves, test_general_moves_pos55) {
  ...
  game_state.board[field_before] = Piece::white_bishop;
  game_state.board[37] = Piece::black_queen;
  game_state.board[62] = Piece::white_rook;
...
TEST(BishopMoves, test_general_moves_pos14) {
  ...
  game_state.board[field_before] = Piece::black_bishop;
  game_state.board[35] = Piece::black_knight;
  game_state.board[5] = Piece::white_knight;
